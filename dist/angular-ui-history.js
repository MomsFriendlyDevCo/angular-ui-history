...
// Main widget {{{
/**
* @param {string} [display='oldestFirst'] The display mode to use. Can be one of: 'oldestFirst', 'recentFirst'
*/
.component('uiHistory', {
	bindings: {
		allowPost: '<',
	...
	controller: ["$element", "$http", "$sce", "$scope", "$timeout", function controller($element, $http, $sce, $scope, $timeout) {
		var $ctrl = this;
